package soialNetworkApp.aop.logging;

import com.fasterxml.jackson.databind.ObjectMapper;
import soialNetworkApp.aop.logging.dto.LoadPathDto;
import soialNetworkApp.errors.UnauthorizedException;
...
public class LogsStorage {
    ...
    @Scheduled(cron = "${logging.file.uploadTime}")
