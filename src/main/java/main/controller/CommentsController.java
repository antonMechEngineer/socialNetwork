...
public class CommentsController {
    ...
    @PostMapping
    public ResponseEntity<CommonResponse<List<Comment>>> createComment(@PathVariable long id, @RequestBody CommentRequest commentRequest) throws NoPostEntityException {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(CommonResponse.<List<Comment>>builder()
                .error("success")
                .timestamp(System.currentTimeMillis())
                .offset(commentsPage.getNumber())
                .perPage(commentsPage.getSize())
                .total(commentsPage.getTotalElements())
                .data(new ArrayList<>(commentsPage.getContent()))
                .build()
        );
    }

    @GetMapping
    public ResponseEntity<CommonResponse<List<Comment>>> getComments(
    ...
    public ResponseEntity<CommonResponse<List<Comment>>> deleteComment(@PathVariable long id, @PathVariable long comment_id) {
    ...
    public ResponseEntity<CommonResponse<List<Comment>>> editComment(
